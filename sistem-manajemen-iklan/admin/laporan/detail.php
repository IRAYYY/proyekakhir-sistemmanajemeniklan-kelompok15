        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div class="bg-white p-5 lg:p-8 rounded-xl shadow">
                ...
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6">
                    ...
                    <span class="<?= $warna; ?> px-3 lg:px-4 py-2 rounded-xl font-semibold text-sm lg:text-base">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xl lg:text-2xl font-bold text-blue-600 break-words">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="bg-gray-50 p-4 rounded-xl break-words">
            ...
            <div class="bg-white p-5 lg:p-8 rounded-xl shadow">
                ...
                <img src="../../assets/uploads/bukti_pembayaran/<?= $data['bukti_pembayaran']; ?>"
                     class="w-full rounded-xl border cursor-pointer hover:scale-[1.01] transition max-h-[500px] object-cover"
                ...
                <div class="text-center mb-6">
                    ...
                    <?php if($data['foto']) : ?>
                        ...
                        <img src="../../assets/uploads/profil/<?= $data['foto']; ?>"
                             class="w-20 h-20 lg:w-24 lg:h-24 rounded-full object-cover mx-auto">

                    <?php else : ?>

                        <div class="w-20 h-20 lg:w-24 lg:h-24 rounded-full bg-gray-200 mx-auto"></div>
...
<div id="modal"
    ...
    <img id="modalImage"
         class="w-[95%] lg:w-auto max-w-5xl max-h-[90vh] rounded-xl">
